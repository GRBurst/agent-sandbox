...
**Three weaknesses the audit of the green run found**, none of them introduced by these fixes and none visible as a failure, all carried to [M10a](#m10a--close-out-status-pending):

...
**Preconditions, measured** — in full in [research.md](research.md#m9--preconditions-for-the-end-to-end-layer-measured-before-it-exists). Three of the first four change this task rather than merely confirming it; the fifth changed the repository, and had to land before this task could be written at all.
